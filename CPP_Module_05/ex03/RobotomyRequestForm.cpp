...
/*   Updated: 2023/02/13 10:14:20 by mtemel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm("robotomy request", sTarget, 72, 45)
{
...
void RobotomyRequestForm::execute(Bureaucrat const &executor) const
{
	...
	if (num % 2)
		std::cout << "\033[4;96m" <<this->getTarget() << " has been robotomized successfully!!\033[0m" << std::endl;
	else
